    ...
    <div>
      <div className="hms-body">
        ...
        <div className="hms-details">
          <CgProfile style={{ color: "black", fontSize: "84px" }} />
          <br />
          {patientDetails && (
            <div>
              <input
        ...
        <div className="hms-vitals">
          <div className="allinput">
            <div className="patient102">
              ...
              <div className="sugar007">
                <label className="right">Sugar(bpm)</label>
                <input
                  className="input007"
                  type="text"
              ...
              <div className="patient103">
              <div className="weight007">
                <label className="right">Weight(kg)</label>
                <input
                  className="input007"
                  type="text"
              ...
              <div className="temp007">
                <label className="right">Temperature(F)</label>
                <input
                  className="input007"
                  type="text"
              ...
              <div className="Pallor007">
                <label className="right">Pallor()</label>
                <input
                  className="input007"
                  type="text"
              ...
              <div className="patient104">
              <div className="Edema007">
                <label className="right">Edema()</label>
                <input
                 className="input007"
                  type="text"
              ...
              <div className="Lcterus007">
                <label className="right">Lcterus(cm)</label>
                <input
                  className="input007"
                  type="text"
              ...
              <div className="Lymphademopathy007">
                <label className="right">Lymphademopathy()</label>
                <input
                  className="input007"
                  type="text"
            ...
            <div className="hms-vitals-all-input-div">
              ...
              <div className="patient105">
              <div className="Cyanosis007">
                <label className="right">Cyanosis()</label>
                <input
                  className="input007"
                  type="text"
              ...
              <div className="JVP007">
                <label className="right">JVP()</label>
                <input
                  className="input007"
                  type="text"
