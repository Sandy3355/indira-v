  ...
  const addMedicineEntry = () => {
    setPrescriptionData((prevData) => ({
      ...
      medicines: [
        ...
        {
          id:
            prevData.medicines.length > 0
              ? prevData.medicines[prevData.medicines.length - 1].id + 1
              : 1,
          medicine: "",
          dose: "1-0-1",
          when: "After Food",
     ...
     <h1 className='heading123'>INDIRA CLINIC</h1>
        ...
        <div className="hms-complaints-diagnosis-div">
          ...
          <div  className="flex12345 ">
            <label className="hms-complaints-diagnosis-label">Diagnosis :</label>
            <CreatableSelect
              className="hms-complaints-ReactSelect1"
              isMulti
              ...
              <tr key={index}>
                ...
                <td className="hms-table-td">
                  <select
                    ...
                    value={medicine.when}
                    onChange={(e) =>
                      handleMedicineChange(index, "when", e.target.value)
                    }
                  >
