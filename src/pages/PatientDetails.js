          ...
          {prescriptionData &&
            prescriptionData.map((prescription, index) => (
              <li key={prescription._id} className="prescription-item">
                      ...
                      <div className="hms-vitals-all-input">
                        <div className="hms-vitals-all-input-div">
                          <div className="hms-vitals-all-input-sub-div">
                            <label className="hms-vitals-labels">BP(mmHg)</label>
                            <input
                        ...
                        <div className="hms-vitals-all-input-div">
                          <div>
                          <label className="hms-vitals-labels">SPO2(%)</label>
                            <input
                              className="hms-inp1 hms-input-highlight"
                              type="text"
                        ...
                        <div className="hms-vitals-all-input-div">
                          <div>
                            <label className="hms-vitals-labels">Clubbing()</label>
                            <input
                              className="hms-inp1 hms-input-highlight"
                              type="text"
                ...
                <table className="hms-tab-medicine">
                  <thead>
                    <tr className="hms-table-th">
                      <th className="hms-table-th-medicine">S No</th>
                      <th className="hms-table-th-medicine">Medicine</th>
                      <th className="hms-table-th-medicine">Dose</th>
                      <th className="hms-table-th-medicine">When</th>
                      <th className="hms-table-th-medicine">Duration</th>
                      <th className="hms-table-th-medicine">Frequency</th>
                      <th className="hms-table-th-medicine">Notes / Instructions</th>
                    </tr>
                  </thead>
                  <tbody>
                    {prescription.medicines && prescription.medicines.length > 0 ? (
                      prescription.medicines.map((medicine, index) => (
                          <tr key={index}>
                            <td className="hms-table-td-medicine">{index + 1}</td>
                            <td className="hms-table-td-medicine">
                              {medicine.medicine}
                            </td>
                            <td className="hms-table-td-medicine">{medicine.dose}</td>
                            <td className="hms-table-td-medicine">{medicine.when}</td>
                            <td className="hms-table-td-medicine">
                              {medicine.duration}
                            </td>
                            <td className="hms-table-td-medicine">
                            ...
                            <td className="hms-table-td-medicine">{medicine.notes}</td>
                          </tr>
